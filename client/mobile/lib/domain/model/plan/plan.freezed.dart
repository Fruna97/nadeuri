...
@override
String toString() {
  return 'Plan(uuid: $uuid, title: $title, googlePlacesId: $googlePlacesId, allDay: $allDay, startAt: $startAt, endAt: $endAt, nadeuriUuid: $nadeuriUuid)';
}
...
class _Plan implements Plan {
  const _Plan({this.uuid, required this.title, this.googlePlacesId, required this.allDay, required this.startAt, required this.endAt, required this.nadeuriUuid});
