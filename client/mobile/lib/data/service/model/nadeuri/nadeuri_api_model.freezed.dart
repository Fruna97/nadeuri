...
mixin _$NadeuriApiModel {
 ...
 String? get uuid; String get title; List<MemberApiModel> get members; List<PlanApiModel> get plans;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NadeuriApiModel&&(identical(other.uuid, uuid) || other.uuid == uuid)&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other.members, members)&&const DeepCollectionEquality().equals(other.plans, plans));
}
...
@override
String toString() {
  return 'NadeuriApiModel(uuid: $uuid, title: $title, members: $members, plans: $plans)';
}
...
@useResult
$Res call({
 String? uuid, String title, List<MemberApiModel> members, List<PlanApiModel> plans
});
...
as List<MemberApiModel>,plans: null == plans ? _self.plans : plans // ignore: cast_nullable_to_non_nullable
as List<PlanApiModel>,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? uuid,  String title,  List<MemberApiModel> members,  List<PlanApiModel> plans)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NadeuriApiModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? uuid,  String title,  List<MemberApiModel> members,  List<PlanApiModel> plans)  $default,) {final _that = this;
switch (_that) {
case _NadeuriApiModel():
return $default(_that.uuid,_that.title,_that.members,_that.plans);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? uuid,  String title,  List<MemberApiModel> members,  List<PlanApiModel> plans)?  $default,) {final _that = this;
switch (_that) {
case _NadeuriApiModel() when $default != null:
return $default(_that.uuid,_that.title,_that.members,_that.plans);case _:
  return null;
...
class _NadeuriApiModel extends NadeuriApiModel {
  const _NadeuriApiModel({this.uuid, required this.title, required final  List<MemberApiModel> members, required final  List<PlanApiModel> plans}): _members = members,_plans = plans,super._();
...
@override List<MemberApiModel> get members {
 ...
 final  List<PlanApiModel> _plans;
@override List<PlanApiModel> get plans {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NadeuriApiModel&&(identical(other.uuid, uuid) || other.uuid == uuid)&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other._members, _members)&&const DeepCollectionEquality().equals(other._plans, _plans));
}
...
as List<MemberApiModel>,plans: null == plans ? _self._plans : plans // ignore: cast_nullable_to_non_nullable
as List<PlanApiModel>,
  ));
}
