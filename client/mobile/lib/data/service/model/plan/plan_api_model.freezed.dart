...
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'PlanApiModel(uuid: $uuid, title: $title, googlePlacesId: $googlePlacesId, latitude: $latitude, longitude: $longitude, allDay: $allDay, startAt: $startAt, endAt: $endAt, nadeuriUuid: $nadeuriUuid)';
}
...
class _PlanApiModel extends PlanApiModel with DiagnosticableTreeMixin {
  const _PlanApiModel({this.uuid, required this.title, this.googlePlacesId, this.latitude, this.longitude, required this.allDay, required this.startAt, required this.endAt, required this.nadeuriUuid}): super._();
