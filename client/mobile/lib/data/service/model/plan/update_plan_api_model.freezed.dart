...
mixin _$UpdatePlanApiModel {
 ...
 String get title; String? get googlePlacesId; bool get allDay; DateTime get startAt; DateTime get endAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,googlePlacesId,allDay,startAt,endAt);

@override
String toString() {
  return 'UpdatePlanApiModel(title: $title, googlePlacesId: $googlePlacesId, allDay: $allDay, startAt: $startAt, endAt: $endAt)';
}
...
@useResult
$Res call({
 String title, String? googlePlacesId, bool allDay, DateTime startAt, DateTime endAt
});
...
/// Create a copy of UpdatePlanApiModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? googlePlacesId = freezed,Object? allDay = null,Object? startAt = null,Object? endAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String? googlePlacesId,  bool allDay,  DateTime startAt,  DateTime endAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdatePlanApiModel() when $default != null:
return $default(_that.title,_that.googlePlacesId,_that.allDay,_that.startAt,_that.endAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String? googlePlacesId,  bool allDay,  DateTime startAt,  DateTime endAt)  $default,) {final _that = this;
switch (_that) {
case _UpdatePlanApiModel():
return $default(_that.title,_that.googlePlacesId,_that.allDay,_that.startAt,_that.endAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  String? googlePlacesId,  bool allDay,  DateTime startAt,  DateTime endAt)?  $default,) {final _that = this;
switch (_that) {
case _UpdatePlanApiModel() when $default != null:
return $default(_that.title,_that.googlePlacesId,_that.allDay,_that.startAt,_that.endAt);case _:
  return null;
...
class _UpdatePlanApiModel extends UpdatePlanApiModel {
  const _UpdatePlanApiModel({required this.title, this.googlePlacesId, required this.allDay, required this.startAt, required this.endAt}): super._();
...
/// Create a copy of UpdatePlanApiModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? googlePlacesId = freezed,Object? allDay = null,Object? startAt = null,Object? endAt = null,}) {
